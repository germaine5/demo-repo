# CFNRegistry::TestService::TestResource

Congratulations on starting development! Next steps:

1. Write the JSON schema describing your resource, `cfnregistry-testservice-testresource.json`
2. Implement your resource handlers in `cfnregistry_testservice_testresource/handlers.py`
